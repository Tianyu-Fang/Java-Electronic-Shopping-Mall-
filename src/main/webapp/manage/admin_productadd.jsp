...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.jsp">Home</a><span class="crumb-step">&gt;</span><a class="crumb-name" href ="javascript:history.go(-1)">Book Management</a><span class="crumb-step">&gt;</span><span>Add New Book</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/E-shop/manage/admin_doproductadd" method="post"  enctype="multipart/form-data" id="myform" name="myform">
